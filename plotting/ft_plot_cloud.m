...
%
% The following inputs apply when 'slice' = 'none' or '3d', or 'slicetype' = 'point'
...
% point density needs to be adjusted based on the unit
ptdens = ptdens*ft_scalingfactor(unit, 'mm')^3;
