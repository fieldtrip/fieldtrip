function L = hh_leadfield(data,compress,node_sizes,row,col, ...
                          slice)
% hh_leadfield is a function to extract the lead field matrix from the
% reciprocity data matrix
%
% L = hh_leadfield(recipdata,compress,node_sizes,row,col,slice)
%
% L:            Lead field matrix
...
% $Log: hh_leadfield.m$
% Revision 1.1 Wed Jul 21 16:35:47 MDT 2010
% Copy from the HHSIM and it has been checked.
