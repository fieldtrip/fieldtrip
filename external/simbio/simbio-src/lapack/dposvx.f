...
*
*  NRHS    (input) INTEGER
*          The number of righthand sides, i.e., the number of columns
...
*          an input variable if FACT = 'F'; otherwise, S is an output
*          variable.  If FACT = 'F' and EQUED = 'Y', each element of S
*          must be positive.
*
