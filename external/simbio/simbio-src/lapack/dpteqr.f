...
*  tridiagonal form. (The reduction to tridiagonal form, however, may
*  preclude the possibility of obtaining high relative accuracy in the
*  small eigenvalues of the original matrix, if these eigenvalues range
...
*     .. External Subroutines ..
      EXTERNAL           DBDSQR, DLAZRO, DPTTRF, XERBLA
*     ..
*     .. Local Arrays ..
