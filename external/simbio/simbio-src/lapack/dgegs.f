...
*
*  The last action is optional -- see the description of JOBVSL and
*  JOBVSR below.  (If only the generalized eigenvalues are needed, use
*  the driver DGEGV instead.)
*
...
*  "standardized" by making the corresponding entries of B have the
*  form:
*          [  a  0  ]
*          [  0  b  ]
*
...
*
*  N       (input) INTEGER
*          The number of rows and columns in the matrices A, B, VSL, and
*          VSR.  N >= 0.
*
...
*     .. External Subroutines ..
     ...
     $                   DLASCL, DLAZRO, DORGQR, DORMQR, XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( ILVSL ) THEN
         CALL DLAZRO( N, N, ZERO, ONE, VSL, LDVSL )
...
*
      IF( ILVSR )
     $   CALL DLAZRO( N, N, ZERO, ONE, VSR, LDVSR )
*
