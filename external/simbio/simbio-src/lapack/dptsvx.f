...
*          X(j) (the j-th column of the solution matrix X).  If XTRUE
*          is the true solution corresponding to X(j), FERR(j) bounds
*          the magnitude of the largest element in (X(j) - XTRUE)
