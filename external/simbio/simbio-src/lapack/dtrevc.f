      SUBROUTINE DTREVC( JOB, HOWMNY, SELECT, N, T, LDT, VL, LDVL, VR,
     $                   LDVR, MM, M, WORK, INFO )
*
...
*  =======
*
*  DTREVC computes all or some right and/or left eigenvectors of a
...
*  factorization of an original matrix A = Q*T*Q**T, then Q*X and/or Q*Y
...
*                  orthogonal) matrix;
*          = 'S':  compute some right and/or left eigenvectors,
...
*          select the complex eigenvector corresponding to a complex
