...
% StartPos  Starting position, if not provided the following data is read continuously from the file.
...
elseif strcmp(HDR.TYPE,'NEX'),
        ...
        for k = 1:HDR.NEX.NS,
                ...
                elseif HDR.NEX.type(k)==5, % continuous variable
