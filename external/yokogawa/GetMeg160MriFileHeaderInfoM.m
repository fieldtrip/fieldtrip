...
%               .cx, .cy, .cz: coordinate of sphere's center [meter]
...
function [data_style, model, marker, image_parameter, normalize, besa_fiducial_point] = GetMeg160MriFileHeaderInfoM( fid )