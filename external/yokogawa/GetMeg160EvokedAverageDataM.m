...
% 
%  usage:
%    data = GetMeg160EvokedAverageDataM( fid, start_sample, sample_length )
% 
%  arguments:
%    fid             : file ID
...
% 
%  return values:
%    data            : (m x n) matrix of measured data [AD]
%                        m: channel_count
%                        n: 1+sample_length (n=1: channel number in Meg160(zero start) )
%  
%  confirmation of revision:
%   GetMeg160EvokedAverageDataM( Inf ) will show and return revision of this function.
%
