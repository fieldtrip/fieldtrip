...
% MEFFIELDTRIP_3P0.GETDATA read data from MEF 3.0 dataset for FieldTrip
%
% Syntax:
%   dat = getData(this)
...
% Copyright 2020 Richard J. Cui. Created: Sun 03/22/2020  4:04:57.766 PM
% $Revision: 0.1 $  $Date: Sun 03/22/2020  4:04:57.785 PM $
%
