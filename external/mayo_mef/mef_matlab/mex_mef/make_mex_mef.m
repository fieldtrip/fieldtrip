...
p = fileparts(mfilename('fullpath')); % directory of make_mex_mef.m
...
cd([p, filesep, 'mef_3p0', filesep, 'matmef', filesep]) % assume 'mef_3p0' is the subdirectory
fprintf('\n')
