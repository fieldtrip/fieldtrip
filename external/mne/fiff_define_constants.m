function [ FIFF ] = fiff_define_constants()
%
%    [ FIFF ] = fiff_define_constants()
%
%    Defines structure containing the FIFF constants
%
...
%
%    Revision 1.22  2009/02/16 04:38:21  msh
%    Fixed comments on coordinate transforms
%
%
%    Revision 1.20  2008/11/16 21:31:23  msh
%    Added mne_transform_coordinates and new coordinate frame definitions
%
%    Revision 1.19  2008/09/30 17:22:39  msh
%    Added possibility to load unprocessed MaxShield data
%
%    Revision 1.18  2008/06/07 21:22:10  msh
%    Added FIFF_FORWARD_SOLUTION_GRAD constant
%
%    Revision 1.17  2008/05/26 10:49:26  msh
%    Update to incorporate the already weighted lead field basis
%
%    Revision 1.16  2008/05/06 20:40:56  msh
%    Fixed ordering of output for compatibility with maxfilter averager
%
%    Revision 1.15  2008/04/16 22:24:57  msh
%    Added megacq parameters to the measurement info
%
%    Revision 1.14  2008/04/16 17:29:28  msh
%    Added acquisition parameter tags.
%
%    Revision 1.13  2008/03/13 19:18:06  msh
%    Read and write FIFF_MEAS_DATE from/to FIFFB_MEAS_INFO as appropriate
%
%    Revision 1.12  2007/01/29 21:21:21  msh
%    Added reading of the additional source prior covariances.
%
%    Revision 1.11  2006/09/25 19:48:16  msh
...
%
%    Revision 1.9  2006/06/22 21:22:46  msh
