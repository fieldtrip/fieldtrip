% Example 5. Rigid CPD point-set registration. Full options intialization.
% if some options are not set, the defaults are used. 3D large stanford bunny point-set (resolution 2).
% Make use of Fast Gauss transform. Try it with FGT (opt.fgt=1) and without
% FGT (opt.fgt=0).

clear all; close all; clc;

load bun_zipper_res2.mat; Y=X;
