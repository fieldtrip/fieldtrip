...
switch cfg.method
  ...
  case 'headshape'
    ...
    if isfield(elec_original, 'coordsys') && strcmp(cfg.warp, 'dykstra2012')
      elec_realigned.coordsys = elec_original.coordsys; % this warp moves the electrodes in the same coordinate space
    end
  case 'fiducial'
    if isfield(target, 'coordsys')
      elec_realigned.coordsys = target.coordsys;
