...
% Neuroimage), being unbiased by the number of spikes.
%
% Use as
%   [sts_tfr] = ft_spiketriggeredspectrum_ppc_tfr(cfg,freq)
%
% Inputs:
...
% NOTE: I left cfg.trials away, since cfg.spikesel can do what cfg.trials
% can do but in a more general way. getting cfg.spikesel from a given set
% of trials is rather easy - so I think we should let users do this
% themselves
