...
%   will be computed. 
%
% cfg paramaters for specfic graph theory functions:
%  cfg.modulegamma   =  This is a paramamter for modularity measure. Default
%                    is 1. <1 gives larger modules, >1 give smaller modules
%  cfg.randomisations = For smallworldness, a number of random networks 
%                        need to be computed. This sets the number of 
