function [hdr] = read_nk1200_header(filename)

% READ_NK1200_HEADER reads the header information from NK1200 files (.EEG) 
...
%
% See also READ_NK1200_DATA, READ_NK1200_EVENT
