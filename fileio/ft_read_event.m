...
% FT_READ_EVENT reads all events from an EEG/MEG dataset and returns them in a well
% defined structure. This function is a wrapper around a large number of iEEG, EEG
% and MEG file importers.
%
% Use as
