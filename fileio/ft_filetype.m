...
elseif isfolder(filename)...
        && filetype_check_extension(filename, {'.mefd', '.timd', '.segd'})
    type = 'mayo_mef30';
    manufacturer = 'Mayo Clinic';
    content = 'Multiscale Electrophysiology Format 3.0';
elseif isfile(filename)...
        && filetype_check_extension(filename, {'.tdat', '.tidx', '.tmet'})...
        && filetype_check_header(filename, uint8(3), 13)...
        && filetype_check_header(filename, uint8(0), 14)
    type = 'mayo_mef30';
    manufacturer = 'Mayo Clinic';
    content = 'Multiscale Electrophysiology Format 3.0';
elseif isfolder(filename)
    ...
    if ~isempty(listing)
        ...
        if filetype_check_header(filemef, uint8(2), 164)...
                && filetype_check_header(filemef, uint8(1), 165)
            type = 'mayo_mef21';
            manufacturer = 'Mayo Clinic';
...
elseif isfile(filename)...
        ...
        && filetype_check_header(filemef, uint8(2), 164)...
        && filetype_check_header(filemef, uint8(1), 165)
    type = 'mayo_mef21';
    manufacturer = 'Mayo Clinic';
    content = 'Multiscale Electrophysiology Format 2.1';
