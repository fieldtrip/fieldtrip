...
if isfield(cfg, 'baseline') && (isfield(cfg, 'demean') || isfield(cfg, 'baselinewindow'))
  error(defaultId, 'conflicting configuration options, you should use cfg.baseline');
   ...
   for k = 1:numel(cfg.parameter)
    ...
    elseif isequal(par, 'individual')
      ...
      elseif d == 2
        ...
        warning(defaultId, 'Not doing anything - matrices up to only three dimensions are supported');
      end
