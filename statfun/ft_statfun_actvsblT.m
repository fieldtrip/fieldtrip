...
switch cfg.dimord
  ...
  otherwise
    error(defaultId, 'Inappropriate dimord for the statistics function FT_STATFUN_ACTVSBLT.');
end
...
df = nunits - 1;
if nunits<2
  error(defaultId, 'The data must contain at least two units (trials or subjects).')
end
if (nunits*2)~=(n1+n2)
  error(defaultId, 'Invalid specification of the design array.');
end
