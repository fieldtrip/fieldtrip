...
%   cfg.ivar  = independent variable, row number of the design that contains the labels of the conditions that must be compared (default=1).
%               The labels should range from 1 to the number of conditions.
