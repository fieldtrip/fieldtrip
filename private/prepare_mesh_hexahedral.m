...
if isempty(cfg.shift)
  warning(defaultId, 'No node-shift selected')
  cfg.shift = 0;
elseif cfg.shift > 0.3
  warning(defaultId, 'Node-shift should not be larger than 0.3')
  cfg.shift = 0.3;
end
...
if shift < 0 || shift > 0.3
  error(defaultId, 'Please choose a shift parameter between 0 and 0.3!');
elseif shift > 0
