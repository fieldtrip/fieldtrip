...
switch cfg.appenddim
  ...
  case 'chan'
    ...
    tmpcfg = keepfields(cfg, {'tolerance', 'channel', 'showcallinfo', 'trackcallinfo', 'trackusage', 'trackdatainfo', 'trackmeminfo', 'tracktimeinfo'});
    tmpcfg.select = 'union';
  ...
  case 'rpt'
    ...
    tmpcfg = keepfields(cfg, {'tolerance', 'channel', 'channelcmb', 'showcallinfo', 'trackcallinfo', 'trackusage', 'trackdatainfo', 'trackmeminfo', 'tracktimeinfo'});
