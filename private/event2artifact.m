function artifact = event2artifact(event)

% EVENT2ARTIFACT converts between two representations of events or trials.
%
...
if isnumeric(trl)
  ...
  artifact = trl(:,1:2);
elseif istable(trl)
  % remove the offset which is the 3rd column, any additional columns can remain
