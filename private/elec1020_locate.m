function [elc, lab] = elec1020_locate(pnt, dhk, nas, ini, lpa, rpa);
...
[cnt1, cnt2] = elec1020_follow(pnt, dhk, Fpz, T7, Oz);
...
[cnt1, cnt2] = elec1020_follow(pnt, dhk, Fpz, T8, Oz);
...
fprintf('AFp contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, AFp7, AFpz, AFp8);
...
fprintf('AF contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, AF7, AFz, AF8);
...
fprintf('AFF contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, AFF7, AFFz, AFF8);
...
fprintf('F contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, F7, Fz, F8);
...
fprintf('FFC contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, FFT7, FFCz, FFT8);
...
fprintf('FC contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, FT7, FCz, FT8);
...
fprintf('FCC contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, FTT7, FCCz, FTT8);
...
fprintf('CCP contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, TTP7, CCPz, TTP8);
...
fprintf('CP contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, TP7, CPz, TP8);
...
fprintf('CPP contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, TPP7, CPPz, TPP8);
...
fprintf('P contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, P7, Pz, P8);
...
fprintf('PPO contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, PPO7, PPOz, PPO8);
...
fprintf('PO contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, PO7, POz, PO8);
...
fprintf('POO contour\n');
[cnt1, cnt2] = elec1020_follow(pnt, dhk, POO7, POOz, POO8);
...
[cnt1, cnt2] = elec1020_follow(pnt, dhk, Nz, T9, Iz);
...
[cnt1, cnt2] = elec1020_follow(pnt, dhk, NFpz, T9h, OIz);
...
[cnt1, cnt2] = elec1020_follow(pnt, dhk, Nz, T10, Iz);
...
[cnt1, cnt2] = elec1020_follow(pnt, dhk, NFpz, T10h, OIz);
