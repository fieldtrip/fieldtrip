...
if ~exist(anafile, 'file'), error(defaultId, 'the file "%s" does not exist', anafile); end
if ~exist(swafile, 'file'), error(defaultId, 'the file "%s" does not exist', swafile); end
if ~exist(spifile, 'file'), error(defaultId, 'the file "%s" does not exist', spifile); end
if ~exist(stmfile, 'file'), error(defaultId, 'the file "%s" does not exist', stmfile); end
if ~exist(bhvfile, 'file'), error(defaultId, 'the file "%s" does not exist', bhvfile); end
