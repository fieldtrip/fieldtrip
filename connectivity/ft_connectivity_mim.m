...
% FT_CONNECTIVITY_MIM computes the multivariate interaction measure from a data-matrix
% containing the cross-spectral density. This implements the method described
% in: Ewald et al., Estimating true brain connectivity from EEG/MEG data invariant to linear and
% static trasformations in sensor space. Neuroimage, 2012; 476:488. This function is a helper function for
...
%
% The output m contains the Parcel*Parcel connectivity measure.
%
