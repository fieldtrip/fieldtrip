...
if displaytext
    fprintf('--------------------------------------\n');
    fprintf('  Multi-class classification by SMLR  \n');
    fprintf('--------------------------------------\n');
end
...
% SMLR 
%---------------------
[w, ix_eff, W, AXall] = smlr_learning(t_train, Xtr, Nfeat, ...
    'wdisplay', wdisp_mode, 'wmaxiter', wmaxiter', 'nlearn', Nlearn, 'nstep', Nstep,...
    'amax', AMAX, 'isplot', isplot', 'gamma0', gamma0);
% w is a column vector which concatenate weight parameters for each class.
