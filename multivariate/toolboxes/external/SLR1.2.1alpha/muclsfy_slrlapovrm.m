function [ww, ix_eff_all, errTable_tr, errTable_te, parm, AXall,Ptr,Pte] =...
    muclsfy_slrlapovrm(x_train, t_train, x_test, t_test, varargin)
% Multiclass classification by SLR-LAP one-versus-rest classifier
% 
% -- Usage
...
% 2009/06/01 OY
% * The function is renamed (previously run_smlr_bi.m)
%
% 2006/10/23 OY
...
if displaytext
    fprintf('-----------------------------------------------------\n');
    fprintf('  Multi-class classification by SLR-LAP one-vs-rest  \n');
    fprintf('-----------------------------------------------------\n');
end
