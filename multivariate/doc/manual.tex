...
\t{ft\_mv\_one_against_one} & one against one classification using a binary classifier\\
\t{ft\_mv\_one_against_rest} & one against rest classification using a binary classifier
\end{tabular}
\label{predictors}
\end{table}
