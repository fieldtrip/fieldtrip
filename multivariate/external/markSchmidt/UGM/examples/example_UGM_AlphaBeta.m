...
%% Alpha-Expansion Decode

alphaExpDecode = UGM_Decode_AlphaExpansion(nodePot,edgePot,edgeStruct,@UGM_Decode_GraphCut,ICMDecoding);

figure(6);
imagesc(reshape(alphaExpDecode,nRows,nCols));
colormap([1 1 1;1 0 0;0 1 0;0 0 1]);
title('Alpha-Expansion Decoding of Noisy X');
fprintf('(paused)\n');
pause