function [t,f_new,g_new,funEvals,H] = WolfeLineSearch(...
    x,t,d,f,g,gtd,c1,c2,LS,maxLS,progTol,debug,doPlot,saveHessianComp,funObj,varargin)
%
        ...
        if 0
            ...
            if nargout == 5
                [t,x_new,f_new,g_new,armijoFunEvals,H] = ArmijoBacktrack(...
                  x,t,d,f,f,g,gtd,c1,max(0,min(LS-2,2)),progTol,debug,doPlot,saveHessianComp,...
                  funObj,varargin{:});
            else
...
while ~done && LSiter < maxLS
    ...
    if ~done && abs((bracket(1)-bracket(2))*gtd_new) < progTol
