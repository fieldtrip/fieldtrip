...
%% Lasso regression
% We will solve min_w ||Xw-y||^2 s.t. sum_i |w| <= tau
%
...
% We will solve min_w ||Xz-y||^2, s.t. sum_i |z| <= tau
% where z and y are complex, and |z| represents the complex modulus
% 
% Efficient projection onto this complex L1-Ball is described:
...
% ||W_g||_2
%
% Note: the bias variables are assigned to group '0', which is not penalized)
%
...
% 
% The auxiliary variable formulation is described in described in the addendum of:
% Schmidt, Murphy, Fung, and Rosales.  <http://www.cs.ubc.ca/~murphyk/Papers/cvpr08.pdf Structure Learning in Random Field for
% Heart Motion Abnormality Detection>.  CVPR (2008).
%
% Computing the projection in the auxiliary variable formulation can be
...
%% L_1,inf Group-Sparse Graphical Lasso
...
% Solve with PQN
fprintf('\nComputing L_1,inf Group-Sparse Graphical Lasso Parameters...\n');
...
%% L_1,2 Group-Sparse Graphical Lasso
...
% Solve with PQN
fprintf('\nComputing L_1,2 Group-Sparse Graphical Lasso Parameters...\n');
W(:) = minConF_PQN(funObj,W(:),funProj);
K = inv(S+W);
...
% of SVMs>
% <http://en.wikipedia.org/wiki/Support_vector_machine#Non-linear_classific
% ation SVMs for Non-linear Classification>
%
...
% Markov random field and the each 'group' e is the set of parameters
...
% conditional random field and the each 'group' e is the set of parameters
% associated with an edge, leading to sparsity in the graph
%
