...
if nargin==0
  ...
  dataset = fullfile(datadir, 'common', 'matlab', 'fieldtrip', 'data','ftp','example','regressconfound', 'TacStimRegressConfound.ds');
else
  dataset = fullfile(datadir, 'TacStimRegressConfound.ds');
end
