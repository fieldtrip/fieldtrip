function tests = test_ft_connectivity_wpli

% MEM 1gb
% WALLTIME 00:10:00
% DEPENDENCY ft_connectivity_wpli
...
result = {};
result{end+1} = ft_connectivity_wpli(input, 'debias', true);
result{end+1} = ft_connectivity_wpli(input, 'debias', false);
