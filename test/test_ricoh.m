...
% This script tests hasricoh, isricohmegfile, read_ricoh_data, read_ricoh_event, read_ricoh_header, & ricoh2grad 

% DATA
%meg_path = < Appropriate path >
%meg_file = 'rightearAEF_export.con';
filename = 'rightearAEF_export.con';   % fullfile(meg_path, meg_file)
