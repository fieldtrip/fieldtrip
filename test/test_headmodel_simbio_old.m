function test_headmodel_simbio_old
...
% spheres model
% development of the simbio headmodel in FT is in progress, I create a new test file for testing
% simbio headmodel, for the time being I leave this script from Cristiano among the test scripts but
% it should be deleted when it is not needed anymore
