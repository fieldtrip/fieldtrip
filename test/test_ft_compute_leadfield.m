...
% meg singlesphere
vol = ft_read_vol('/home/common/matlab/fieldtrip/data/test/latest/vol/Subject01vol_singlesphere.mat');
...
% meg singleshell
vol = ft_read_vol('/home/common/matlab/fieldtrip/data/test/latest/vol/Subject01vol_singleshell.mat');
load('/home/common/matlab/fieldtrip/data/test/latest/raw/meg/preproc_ctf151');
sens = data.grad;
[vol, sens] = ft_prepare_vol_sens(vol, sens);
lf = ft_compute_leadfield([4 3 8], sens, vol);
...
% meg localsphere
vol = ft_read_vol('/home/common/matlab/fieldtrip/data/test/latest/vol/Subject01vol_localspheres.mat');
load('/home/common/matlab/fieldtrip/data/test/latest/raw/meg/preproc_ctf151');
sens = data.grad;
[vol, sens] = ft_prepare_vol_sens(vol, sens);
lf = ft_compute_leadfield([4 3 8], sens, vol);
