function test_ft_connectivity_amplcorr_ortho

% TEST: test_ft_connectivity_amplcorr_ortho
% TEST: ft_connectivity_amplcorr_ortho

mom1 = randn(1,100)+1i*randn(1,100);
mom2 = randn(1,100)+1i*randn(1,100);

c = ft_connectivity_amplcorr_ortho([mom1;mom2], 'refindx', 1);
c = c(2,:);
