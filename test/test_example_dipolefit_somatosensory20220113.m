...
cfg.numdipoles = 1;
cfg.hdmfile = dccnpath('/home/common/matlab/fieldtrip/data/SubjectBraille.hdm');
...
mri = ft_read_mri(dccnpath('/home/common/matlab/fieldtrip/data/SubjectBraille.mri'));
