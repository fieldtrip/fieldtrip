...
% determine the geometrical units of the first object
varargin{1} = ft_convert_units(varargin{1});
unit = varargin{1}.unit;
for k = 2:ndata
  % convert all subsequent objects to the same units as the first
