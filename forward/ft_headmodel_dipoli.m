...
if isempty(conductivity)
  ...
  elseif numboundaries == 4
    ...
    error(defaultId, 'Conductivity values are required!')
  end
...
switch mexext
  ...
  otherwise
    error(defaultId, 'there is no dipoli executable for your platform');
end
...
try
  ...
  error(defaultId, 'an error ocurred while running the dipoli executable - please look at the screen output');
end
