function write_materials(filename,values,labels,weights)
%
% write_materials writes a .mat file (read by the simbio/vgrid mesh generator)
% in which each tissue compartment is assigned to an integer value 
%
% Use as
%   write_materials(values,labels,weights)
% 
% where:
