...
if strcmp(mfilename,'ft_trialfun_edf')
  warning(defaultId, 'this trial function is only an example, please copy it and adapt it to your specific EDF situation - see http://www.fieldtriptoolbox.org/getting_started/edf');
end
