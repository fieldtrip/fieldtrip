...
% of the new CSD matrix (not just the diagonal). This can be used for 
% estimating forward projection  of the eigencecomposition  (experimetnal!).
% 
% If compenent is 'real1' or 'real2'  the re-estimated power is computed 
% from either the 1st or 2nd eigenvector of the decomposition of the real 
% part of the CSD. (see ref for details). 
%
% Use as
...
%                  decompose:  'imag', 'imag+rop', 'real1' or 'real2'. 
%                  (Default = 'imag'). See above.
%                
%
...
elseif strcmp(component,'imag') 
    ...
    isimag=1;
    outprod=0;
elseif strcmp(component,'imag+rop') 
    eig_idx=1;
    isimag=1;
    outprod=1;
else 
    ...
    for i_foi=1:n_foi
        for i_toi=1:n_toi
            ...
            eig_diag=abs((q).^2.*lambda);
             ...
             if outprod
                 %  compute real outer-product, if specfied
