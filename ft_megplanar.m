...
data  = ft_checkdata(data, 'ft_datatype', {'raw' 'freq'}, 'feedback', 'yes', 'hastrialdef', 'yes', 'ismeg', 'yes', 'senstype', {'ctf151', 'ctf275', 'bti148', 'bti248', 'itab153'});
...
if istlck
  ...
  interp = ft_checkdata(interp, 'ft_datatype', 'timelock');
  israw  = false;
end
