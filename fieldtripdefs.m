...
% ft_ft_hastoolbox function appears not be found in fieldtrip/private.
...
if isempty(which('ft_ft_hastoolbox'))
  % the fieldtrip/public directory contains the ft_ft_hastoolbox function
