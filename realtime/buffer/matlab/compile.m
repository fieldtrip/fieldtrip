...
if ispc
  ...
  % link all the objects together into a mex file
  mex -I../src -I../pthreads-win32/include -L../src -L../pthreads-win32/lib buffer.c gettimeofday.obj buffer_gethdr.obj buffer_getdat.obj buffer_getevt.obj buffer_getprp.obj buffer_flushhdr.obj buffer_flushdat.obj buffer_flushevt.obj buffer_puthdr.obj buffer_putdat.obj buffer_putevt.obj buffer_putprp.obj -lbuffer -lpthreadVC2.bcb
else
  % link all the objects together into a mex file
