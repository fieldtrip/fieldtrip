...
% FT_REALTIME_FMRIPROXY simulates an fMRI acquisition system by writing volumes
% in a cycle of about 2 seconds. The voxel data is written as a column vector with
% X*Y*Z channels, where X and Y are the readout and phase-encoding resolution, and
% Z is the number of slices. The voxel data consists of a ellipsoid (a bit like a head)
% with added lateralized activation (20 scan cycle) and noise.
%
