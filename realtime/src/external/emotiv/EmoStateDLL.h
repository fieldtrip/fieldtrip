...
//DEPLOYMENT::STABLE_RELEASE::REMOVE_START
	...
	//@@ Use EE_CognitivGetOverallSkillRating and EE_CognitivGetActionSkillRating instead

	//! Returns the current Cognitiv level rating of the user
	/*!
		\param state - EmoStateHandle

		\return level rating (0 to 100)

	*/
	EMOSTATE_DLL_API float ES_CognitivGetCurrentLevelRating(EmoStateHandle state);

	//! Returns the individual Cognitiv action skills at the current level
	/*!
		\param state - EmoStateHandle
		\param action1Skill - skill rating of action 1
		\param action2Skill - skill rating of action 2
		\param action3Skill - skill rating of action 3
		\param action4Skill - skill rating of action 4

	*/
	EMOSTATE_DLL_API void ES_CognitivGetActionSkills(EmoStateHandle state,
								int* action1Skill, int* action2Skill, int* action3Skill, int* action4Skill);
