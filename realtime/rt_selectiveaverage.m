function rt_selectiveaverage(cfg)

% RT_SELECTIVEAVERAGE is an example realtime application for online
% averaging of the data. It should work both for EEG and MEG.
%
% Use as
%   rt_selectiveaverage(cfg)
...
%
% $Log: rt_selectiveaverage.m,v $
% Revision 1.6  2009/04/21 09:59:52  roboos
