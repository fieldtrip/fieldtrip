...
% ALIGN_FSAVERAGE2MNI performs an affine alignment of the anatomical
% volume from FSAVERAGE towards MNI coordinates. Only the homogeneous transformation
% matrix is modified and the coordsys-field is updated.
%
% Use as
%   mri = align_fsaverage2mni(mri)
% where mri is a FieldTrip MRI-structure
%
