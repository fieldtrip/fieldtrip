...
%
% The raw datatype represents sensor-level time-domain data typically obtained after
% calling FT_DEFINETRIAL and FT_PREPROCESSING. It contains one or multiple
% segments of data, each represenetd as Nchan X Ntime
% arrays.
%
% An example of a raw data structure with 275 MEG channels is shown here
%
...
% Revision history:
%
% (2010-2/latest) The trialdef field has been replaced by the sampleinfo and
% trialinfo fields. The sampleinfo corresponds to trl(:,1:2), the trialinfo
% to trl(4:end).
%
% (2010-1) In 2010/Q3 it shortly contained the trialdef field which was a copy 
